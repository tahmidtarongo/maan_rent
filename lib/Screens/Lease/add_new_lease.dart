...
import 'package:maan_rent/Screens/Lease/lease_list.dart';
import 'package:nb_utils/nb_utils.dart';

import '../../constant.dart';

class AddNewLease extends StatefulWidget {
  const AddNewLease({Key? key}) : super(key: key);

  @override
  _AddNewLeaseState createState() => _AddNewLeaseState();
}

class _AddNewLeaseState extends State<AddNewLease> {
              ...
              child: Column(
                children: [
                  ...
                  ButtonGlobal(
                      ...
                      onPressed: () {
                        const LeaseList().launch(context);
                      }),
                ],
              ),
            ),
